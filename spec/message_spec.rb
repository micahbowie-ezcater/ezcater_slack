...
RSpec.describe EzcaterSlack::Message do
  ...
  describe '#compile' do
    it 'compiles the message with blocks, channels, and tagged users' do
      ...
      expect(compiled_message).to be_a(EzcaterSlack::Message::Compilation)
  ...
  describe '#compile' do
    ...
    it 'compiles the message payload with given arguments' do
      ...
      expect(compilation).to be_an_instance_of(EzcaterSlack::Message::Compilation)
